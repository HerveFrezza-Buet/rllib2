...
using params = rl2::eigen::nuplet::from<rl2::linear::discrete_a::q_dim_v<rl2::problem::defs::cartpole::S,
                                                                         rl2::problem::defs::cartpole::A,
                                                                         s_feature>>;
using Q      = rl2::linear::discrete_a::q<params,
                                          rl2::problem::defs::cartpole::S,
                                          rl2::problem::defs::cartpole::A,
                                          s_feature>;

// Our cartpole needs to be defined, in order to handle enumerable actions.
using system = rl2::enumerable::discrete_a::system<rl2::problem::defs::cartpole::S,
                                                   rl2::problem::defs::cartpole::S,
                                                   rl2::problem::defs::cartpole::A,
